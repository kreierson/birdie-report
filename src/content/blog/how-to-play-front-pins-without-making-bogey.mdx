...
This is the same adult logic behind [stop short-siding yourself](/blog/stop-short-siding-yourself-approach-strategy/), [course management tips](/blog/course-management-tips/), and [recovery shot strategy](/blog/recovery-shot-strategy-stop-doubles/). If the thing making front pins even nastier is hard summer surfaces, go read [how to play firm greens without short-siding yourself](/blog/how-to-play-firm-greens-without-short-siding-yourself/) right after this. The hole is giving you a warning. Listen the first time.
...
And if the pin is actually in the safe middle section but you still keep turning it into a 35-footer or a wrong-side miss, go straight to [how to play middle pins better](/blog/how-to-play-middle-pins-better/). That is the cleaner "when can I actually be precise?" follow-up.
