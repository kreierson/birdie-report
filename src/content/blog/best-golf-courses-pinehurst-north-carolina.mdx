...
featured_image: "https://images.unsplash.com/photo-1584837140804-599306fb37f9?w=1200&q=80"
featured: true
...
If you want the current access rules, package premium, caddie math, and maintenance timing before you book, read the full [Pinehurst No. 2 review](/blog/pinehurst-no-2-review/).
...
If you want the current guest-only access rules, cart-path and caddie setup, maintenance timing, and the full case for why No. 4 may actually be the smarter splurge for most golfers, read the full [Pinehurst No. 4 review](/blog/pinehurst-no-4-review/).

### Pinehurst No. 10 — The Walking-Only Sandmines Wild Card

**Access:** Resort guests only | **Rating:** 9.0/10

If No. 2 is the history lecture and No. 4 is the broader-appeal premium round, **No. 10** is the modern adventure branch.

Tom Doak's Sandmines course is walking only, built across more rugged ground, and feels like Pinehurst reminding everyone it can still do something new instead of just polishing the old trophies. If you want the full guest-only access rules, caddie math, maintenance timing, and the case for where it fits in the resort pecking order, read the full [Pinehurst No. 10 review](/blog/pinehurst-no-10-review/). If you already know the round is on your trip and just want the practical survive-it-better version, use the new [Pinehurst No. 10 first-timer guide](/blog/pinehurst-no-10-first-timer-guide-2026/).
...
If you want the current posted 2026 rates, public booking window, package angle, and the full case for where it fits on a Sandhills trip, read the new [Mid Pines Inn & Golf Club review](/blog/mid-pines-inn-golf-club-review/).
...
If you want the current posted 2026 rates, public booking window, Ross-package angle, and the full case for why Pine Needles may be the smartest premium non-resort splurge in the area, read the full [Pine Needles review](/blog/pine-needles-review/).

### Southern Pines Golf Club

**Green Fee:** $165-$245 depending on season | **Rating:** 8.9/10

Southern Pines is the public-access Ross answer for golfers who want the Sandhills feel without building the entire trip around resort-only access rules. The current official site says the course is open to members, guests, and the general public, with outside players able to book up to 30 days in advance.

That is a very attractive sentence in this market.

The current posted rate table also makes the fit pretty clear: it is still premium golf, but it is much easier to defend than another full-resort splurge. If you want the full case for where it fits on a Sandhills trip, read the new [Southern Pines Golf Club review](/blog/southern-pines-golf-club-review/).
...
If you want the current daily-fee booking rules, dynamic-pricing setup, cancellation policy, and the full case for where it fits on a Sandhills trip, read the new [Tobacco Road review](/blog/tobacco-road-review/).
