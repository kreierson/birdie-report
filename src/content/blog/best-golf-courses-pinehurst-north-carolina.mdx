...
Tom Doak's Sandmines course is walking only, built across more rugged ground, and feels like Pinehurst reminding everyone it can still do something new instead of just polishing the old trophies. If you want the full guest-only access rules, caddie math, maintenance timing, and the case for where it fits in the resort pecking order, read the full [Pinehurst No. 10 review](/blog/pinehurst-no-10-review/).
