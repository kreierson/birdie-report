...
description: "An honest guide to breaking 80. No magic fixes—just the stuff that actually works when you stop lying to yourself about your game."
date: 2026-03-16
updated: 2026-08-19
category: tips
...
seo_description: "Honest advice on breaking 80 from a golfer who tests everything. Skip the YouTube tips and learn what actually moves the needle in your game."
---
...
## Your Break-80 Scorecard

You do not need tour-level numbers. You need a round with enough boring outcomes and very few disasters.

| Category | Practical break-80 target |
|---|---|
| **Penalty strokes** | 0-1 |
| **Doubles or worse** | 0-1 |
| **Three-putts** | 0-1 |
| **Greens in regulation** | Roughly 8-10 |
| **Up-and-downs** | Save 3-4 of the greens you miss |
| **Birdies required** | Zero |

Those are planning targets, not entry requirements. A hot putting day can cover fewer greens. Great ball striking can cover a mediocre short game. What usually cannot be covered is two penalties, three doubles, and three three-putts in the same round.

Before the first tee, mark the six or seven holes where bogey is acceptable. Long par 3, narrow driving hole, brutal approach, whatever. The point is to decide where **not** to force par before adrenaline starts doing the strategy for you.
...
Build the tee-shot decision before the round with the broader [course-management guide](/blog/course-management-tips/) instead of negotiating with your ego while standing on the box.
...
Use the [30-80 yard pitch-distance system](/blog/pitch-shot-distance-control-scoring-zone/) to turn those practice numbers into repeatable carries.
...
Start with the boring, repeatable technique in the [chipping guide](/blog/chip-shot-technique-around-the-green/) before adding specialty shots.

## Step 4: Eliminate Three-Putts

Three-putt avoidance starts with pace. The [lag-putting guide](/blog/lag-putting-tips-eliminate-three-putts/) gives you the distance-control practice; this section gives you the scoring rule.
...
If this is where rounds keep exploding, use the [three-question recovery-shot plan](/blog/recovery-shot-strategy-stop-doubles/) until the safe choice becomes automatic.
