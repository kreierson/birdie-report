...
If the shot starts pushing into that awkward **8-15 yard** carry window where a basic chip no longer really fits, go read [how to control 8-15 yard pitch shots](/blog/how-to-control-8-to-15-yard-pitch-shots/). That is the cleaner answer when you need a mini-pitch instead of a bumped runner.
