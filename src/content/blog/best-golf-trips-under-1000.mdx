...
Myrtle Beach is a buddy-trip staple because its broad course inventory and package market give groups many ways to control the budget. Build the shortlist with our current [best golf courses in Myrtle Beach guide](/blog/best-golf-courses-myrtle-beach-south-carolina/), then price the exact dates instead of relying on a fixed course count or old rate.

**Courses to play:**
- **Caledonia Golf & Fish Club** — The first premium round to price; seasonal rates change.
- **True Blue Golf Club** — A logical pairing with Caledonia and a strong choice for mixed-handicap groups.
- **Tidewater Golf Club** — The scenic north-end round to add variety.
- **Heritage Club or a Barefoot course** — Use the live rate and location to fill the value slot.

**Where to stay:** Choose the lodging after the courses. Pawleys Island or Murrells Inlet is more efficient for a Caledonia/True Blue-heavy trip; North Myrtle Beach makes more sense for Tidewater and Barefoot.
