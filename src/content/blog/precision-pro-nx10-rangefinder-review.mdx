...
If your real decision is "smart value buy versus premium-tech temptation," read the new [Precision Pro NX10 vs Voice Caddie TL1 comparison](/blog/precision-pro-nx10-vs-voice-caddie-tl1/). If your real decision is even simpler and more common than that, go straight to [Bushnell Tour V6 Shift vs Precision Pro NX10](/blog/bushnell-tour-v6-shift-vs-precision-pro-nx10/). Those are the two forks most golfers should actually care about.
