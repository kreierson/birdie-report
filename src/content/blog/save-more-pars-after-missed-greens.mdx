...
If thick greenside rough is the part that keeps turning a normal miss into a panic swing, go read [how to chip from greenside rough](/blog/how-to-chip-from-greenside-rough/). That shot needs a different plan than clean turf or tight-cut chips.
...
If your home course gives you grainy collars, uphill bump shots, and bunker shots to greens running away, practice those. If the grainy-collar version keeps eating your lunch, go read [how to chip into grain without leaving it short](/blog/how-to-chip-into-grain-without-leaving-it-short/) and then actually rehearse that shot. Do not spend your whole short-game session hitting magazine-cover flops you use twice a month.
