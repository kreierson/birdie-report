...
If your brain is less interested in older-model savings and more interested in whether a current feel-first forged challenger is enough wedge to skip the benchmark tax, the sharper current fork is now [Mizuno Pro T-1 vs Titleist Vokey SM11](/blog/mizuno-pro-t1-vs-titleist-vokey-sm11/) after the new [Mizuno Pro T-1 review](/blog/mizuno-pro-t1-wedge-review/).
