...
If your first question is whether the new one is actually worth paying up for over the older one, read [Titleist Vokey SM11 vs Titleist Vokey SM10](/blog/titleist-vokey-sm11-vs-titleist-vokey-sm10/) next.
