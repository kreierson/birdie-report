...
And if you want the current week that should feed straight into that major, read [our July Women's Scottish Open field recap](/blog/womens-scottish-open-field-dundonald-2026/) and [the companion opinion on why Dundonald should not be treated like a disposable warm-up](/blog/womens-scottish-open-not-a-warm-up-opinion-2026/).
