...
Most golfers do not need a mystical green-reading gift. They need a **system** they can repeat before every putt.
...
The faster you intend the ball to arrive, the less time gravity has to move it sideways—but the comeback putt also gets longer when you miss. Pick the capture speed before choosing the final aim point.
...
- **Grain direction:** Confirm it from the surface and cup edge instead of relying on folklore about the sun or the nearest pond.

If that darker into-grain look keeps turning good putts into dead-short misses, go straight to [how to putt into grain without leaving it short](/blog/how-to-putt-into-grain-without-leaving-it-short/). That page is the narrower pace-and-break version of this grain section.
...
The best read in the world is useless if the ball does not start where you aimed it.

1. Pick a straight 6-foot putt.
2. Place two tees just wider than the ball, about 12 inches in front of it.
3. Roll ten putts through the gate without caring whether they drop.
4. Move to a breaking putt, choose the start line, and rebuild the gate on that line.

If the ball repeatedly misses the same side of the gate, you have a start-line problem. If it starts through the gate but misses the cup, adjust the read or speed. That separation keeps you from “fixing” your stroke after a bad read—or changing your read after a bad stroke.
