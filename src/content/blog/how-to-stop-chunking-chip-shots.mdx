...
If the bigger problem is bare or tight turf where a thin miss shows up fast, go read [how to chip tight lies without blading it](/blog/how-to-chip-tight-lies-without-blading-it/). Same contact issue, less grass forgiveness.
