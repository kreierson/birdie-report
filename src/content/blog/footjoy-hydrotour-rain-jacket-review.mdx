...
If your debate is whether the HydroTour's extra armor is actually worth the jump over a sharper mid-premium shell, the new [Nike Storm-FIT ADV vs FootJoy HydroTour](/blog/nike-storm-fit-adv-vs-footjoy-hydrotour/) page is the better rabbit hole.

If your real question is whether the HydroTour is worth the extra spend over the site's best-value shell, read [FootJoy HydroTour vs Under Armour Drive](/blog/footjoy-hydrotour-vs-under-armour-drive/) next.
...
That does not mean it will feel as light or easygoing as something like the **HydroLite X**. It means the HydroTour is trying to preserve playability while still acting like a proper storm shell. If that is your exact debate inside FootJoy's lineup, go straight to [FootJoy HydroLite X vs FootJoy HydroTour](/blog/footjoy-hydrolite-x-vs-footjoy-hydrotour/).
...
If you are specifically trying to decide whether the HydroTour's extra storm protection is worth the extra money over FootJoy's lighter shell, read [FootJoy HydroLite X vs FootJoy HydroTour](/blog/footjoy-hydrolite-x-vs-footjoy-hydrotour/).
