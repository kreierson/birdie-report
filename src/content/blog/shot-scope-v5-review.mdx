...
If you know you do **not** care about shot tracking and mostly want a watch that gives you yardages, lives forever on a charge, and stays out of your way, the [Garmin Approach S12](/blog/shot-scope-v5-vs-garmin-approach-s12/) has a better simplicity case.
...
The **Garmin S12** is better if you care more about **button-control simplicity**, **long battery life**, and a watch that asks less of you. If that is the fork you are actually on, the sharper read is the new [Shot Scope V5 vs Garmin Approach S12 comparison](/blog/shot-scope-v5-vs-garmin-approach-s12/).
...
If you just want yardages and quiet simplicity, you can absolutely make a case for the [Garmin Approach S12](/blog/shot-scope-v5-vs-garmin-approach-s12/).
