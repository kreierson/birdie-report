...
And if most of these wedges show up after a second-shot layup, go read [how to lay up on par 5s](/blog/how-to-lay-up-on-par-5s/) too. Better wedge numbers start with better second-shot planning, not just cleaner contact.
...
Do not force the hero shot. Use the club that covers the back tier with a quieter swing. The worst miss from 115 to a back pin is usually not long. It is the chunk that never reaches the shelf. If back-hole locations keep baiting you into depth-control stupidity, read [how to play back pins better](/blog/how-to-play-back-pins-better/) next.
