...
If you want another adjacent matchup after this one, go read [Pro V1 vs Tour Response](/blog/pro-v1-vs-tour-response/), [Chrome Soft vs AVX](/blog/chrome-soft-vs-avx/), and the new [Tour B RXS vs Tour Response](/blog/tour-b-rxs-vs-tour-response/). Those three explain the rest of this part of the ball market pretty well.
