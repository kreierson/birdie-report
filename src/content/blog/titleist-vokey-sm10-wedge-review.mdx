...
If you are reading this because the new generation exists and you are trying to figure out whether the older Vokey is now the smarter value, start with the new [Titleist Vokey SM11 review](/blog/titleist-vokey-sm11-review/) and the direct [Titleist Vokey SM11 vs Titleist Vokey SM10 comparison](/blog/titleist-vokey-sm11-vs-titleist-vokey-sm10/).
