...
If you are staring at a GT2 and a same-money Cobra max head, go directly to [Titleist GT2 vs Cobra Darkspeed Max Driver](/blog/titleist-gt2-vs-cobra-darkspeed-max-driver/). That page gets to the real neutral-versus-draw-bias decision much faster than another generic roundup.
