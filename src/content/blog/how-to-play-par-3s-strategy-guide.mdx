...
Par 3s look simple because the green is right in front of you. That is exactly why golfers make stupid decisions on them: visible flag, clean lie, instant permission to fire at trouble.

You have no fairway to miss and no layup decision, but you still need a target, a carry number, and a plan for your normal miss. Treating every par 3 like a closest-to-the-pin contest is how a routine bogey becomes a double.
...
**Error 2: You take too little club.** Golfers remember the flushed carry and quietly delete every ordinary strike from memory. Choose from your normal carry, not the number you produced once with a tailwind and a personal grudge.
...
If the specific thing that keeps wrecking you is an approach forced over water, pair this with [how to hit approach shots over water without flinching](/blog/how-to-hit-approach-shots-over-water-without-flinching/). Same target discipline, a little more carry margin, a lot less pond.
...
## Strategy by Yardage Band

| Tee-shot distance | Default goal | Best miss |
|---|---|---|
| **Under 130 yards** | Favor the pin only with a comfortable full number and safe miss | Putting surface or wide side of green |
| **130-170 yards** | Center-green target unless the flag is genuinely accessible | Pin-high on the fat side |
| **170-200 yards** | Front-middle carry with enough club to cover the main hazard | Short-side avoided, even if you miss the green |
| **Over 200 yards** | Treat bogey as acceptable and remove penalty trouble | Safe fringe or simple chip area |

Then overlay your actual pattern. If eight of ten shots finish right, “middle” is not your aim point. Shift the start line left enough that the center of your pattern—not the prettiest ball—covers the safe zone.
...
- Long irons (3-5): tee it up about an eighth of an inch. Just enough to give a clean lie without changing your swing.
- Mid irons (6-8): barely off the ground. Think "sitting just proud of the grass."
- Short irons/wedges: nearly flush, or just place the ball on a pushed-down tee

If your iron par-3 shots keep coming out floaty, thin, or weirdly high, go read [how to tee up iron shots on par 3s](/blog/how-to-tee-up-iron-shots-on-par-3s/). That page is the tighter follow-up on exact tee-height numbers and strike checkpoints.
