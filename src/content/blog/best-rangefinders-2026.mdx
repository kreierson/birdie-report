...
If the sharper value question is whether Precision Pro still earns the extra money over Shot Scope's cheaper feature set, read [Precision Pro NX10 vs Shot Scope PRO L2](/blog/precision-pro-nx10-vs-shot-scope-pro-l2/).
