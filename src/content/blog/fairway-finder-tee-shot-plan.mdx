...
If the hole gives you two routes instead of one, take this thinking straight into [how to play split-fairway tee shots without picking the dumb side](/blog/how-to-play-split-fairway-tee-shots/). Split fairways are where "smart club" and "smart route" finally have to work together.
...
Once you make the club choice, stop lingering. A cleaner [pre-shot routine](/blog/pre-shot-routine-12-second-commit-system/) matters here because a smart tee-shot plan still falls apart if you stand over the ball long enough to talk yourself into a steer-job swing.
