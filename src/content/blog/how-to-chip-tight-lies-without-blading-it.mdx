...
If chunked contact is the bigger problem in general, start with [how to stop chunking chip shots](/blog/how-to-stop-chunking-chip-shots/) and [chip shot technique around the green](/blog/chip-shot-technique-around-the-green/). This piece is for the specific lie that makes golfers suddenly distrust their own hands.
