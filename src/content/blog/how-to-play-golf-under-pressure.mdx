...
If you want a tighter structure for that piece of the puzzle, use [the 12-second commit system](/blog/pre-shot-routine-12-second-commit-system/). It is a much cleaner way to stop standing over the ball until your courage leaks out.
