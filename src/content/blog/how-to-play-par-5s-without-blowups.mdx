...
If the smart call is already obvious and you just want the tighter "what number should I leave?" answer, jump next to [how to lay up on par 5s](/blog/how-to-lay-up-on-par-5s/). That page is the more specific follow-up for golfers who keep turning sensible layups into awkward wedge numbers.
If the shot looks reachable and your real question is whether this is an actual green light or just you getting emotionally loose with a fairway wood, go read [when to go for par 5s in two](/blog/when-to-go-for-par-5s-in-two/).
...
If your second shot is drifting into true long-club territory, use the same harsher rules from [our 225-plus yard approach guide](/blog/approach-strategy-225-plus-yards/). Par 5s get expensive when "reachable" turns into fiction.
