...
If the bigger issue is basic tight-turf contact, start with [how to chip tight lies without blading it](/blog/how-to-chip-tight-lies-without-blading-it/) and [how to stop chunking chip shots](/blog/how-to-stop-chunking-chip-shots/). This piece is for the specific lie that adds slope, speed, and panic all at once.
