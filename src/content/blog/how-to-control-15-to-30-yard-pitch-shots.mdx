...
If the shot is under about **10-12 yards**, I still want the simpler [chip-shot route](/blog/chip-shot-technique-around-the-green/) whenever the lie and green allow it. If the shot stretches into the bigger scoring windows, move to [pitch-shot distance control in the scoring zone](/blog/pitch-shot-distance-control-scoring-zone/) and [the 40-60 yard wedge system](/blog/how-to-control-wedges-40-to-60-yards/).
